	...
	<body>
		...
		<table id="dg" title="客户开发计划管理" class="easyui-datagrid"
		    ...
		    <tr>
		        ...
		        <th field="customerName" width="150" align="center">客户名称</th>
		        ...
		        <th field="devResult" width="150" align="center" formatter="formatDevResult" >客户开发状态</th>
		        <th field="操作" width="100" align="center" formatter="formatOptBtn" >操作</th>
		    </tr>
		    </thead>
		</table>
